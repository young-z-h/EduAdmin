...
public class CourseDao {
    ...
    public Collection<Course> findAll() throws SQLException{
        ...
        while (resultSet.next()){
            Course course = new Course(
                    ...
                    CourseTypeService.getInstance().find(resultSet.getInt("courseType_id")),
    ...
    public void delete(Course course) throws SQLException {
        ...
        try {
            ...
            String deleteTeaching_sql = "DELETE FROM teaching WHERE Course_id = ?";
            pstmt = connection.prepareStatement(deleteTeaching_sql);
            pstmt.setInt(1,course.getId());
